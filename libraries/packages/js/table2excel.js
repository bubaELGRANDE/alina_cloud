...
(function ( $, window, document, undefined ) {
    ...
    Plugin.prototype = {
        init: function () {
            ...
            $(e.element).each( function(i,o) {
                ...
                $(o).find("tr").not(e.settings.exclude).each(function (i,p) {
					...
					// Create HTML for Row
                    tempRows += "<tr style='color: black;" + additionalStyles + "'>";
        ...
        tableToExcel: function (table, name, sheetName) {
            ...
            e.ctx = {
                worksheet: name || "Libro de calculo",
                table: table,
                sheetName: sheetName
            };
            ...
            if ( $.isArray(table) ) {
                 Object.keys(table).forEach(function(i){
                      ...
                      fullTemplate += e.template.sheet.head + sheetName + (parseInt(i + 1)) + e.template.sheet.tail;
                });
            }
    ...
    function getFileName(settings) {
        return ( settings.filename ? settings.filename : "Libro de calculo" );
    }
