<?php 
    ...
    $dataExpedientes = $cloud->row("
        ...
        WHERE exp.flgDelete = 0 AND exp.prsExpedienteId = ?
    ",[$arrayFormData[0]]);
?>
...
<input type="hidden" id="personaId" name="personaId" value="<?php echo $dataExpedientes->personaId; ?>">
<input type="hidden" id="nombreCompleto" name="nombreCompleto" value="<?php echo $dataExpedientes->nombreCompleto; ?>">
<input type="hidden" id="nombreUsuario" name="nombreUsuario" value="<?php echo $dataExpedientes->nombreUsuario; ?>">
<div class="row">
    <div class="col-md-6">
        ...
        $("#frmModal").validate({
            submitHandler: function(form) {
                mensaje_confirmacion(
                    '¿Está seguro que desea dar de baja al empleado <?php echo $dataExpedientes->nombreCompleto; ?>', 
                        ...
                        asyncFile(
                            ...
                            function(data) {
                                ...
                                if(data == "success") {
                                    ...
                                    $('#tblExpedientesBajas').DataTable().ajax.reload(null, false);
                                    $('#tblExpedientesFinalizados').DataTable().ajax.reload(null, false);
                                    $('#tblExpedientesJubilados').DataTable().ajax.reload(null, false);
