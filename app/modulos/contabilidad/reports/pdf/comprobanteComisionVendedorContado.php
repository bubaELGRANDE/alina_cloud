    ...
    */
    ...
    if($filtroVendedores == "Todos") {
        ...
        $dataVendedores = $cloud->rows("
            ...
            WHERE comisionPagarPeriodoId = ? AND flgIdentificador = 'F' AND flgDelete = '0'
        ...
        $dataVendedores = $cloud->rows("
            SELECT
                ...
                comisionPagarEditar
            FROM conta_comision_pagar_calculo
            WHERE comisionPagarPeriodoId = ? AND nombreEmpleado IN ($vendedores) AND flgIdentificador = 'F' AND flgDelete = '0'
            ORDER BY nombreEmpleado, lineaProducto, fechaFactura
        ", [$comisionPagarPeriodoId]);
    ...
    $subtituloReporte = 'Periodo: ' . $periodo . ' (Contado)';

    $outputReporte = 'Comprobante de comisiones por vendedor (Contado) - ' . $periodo . ' - ' . $filtroVendedores;
