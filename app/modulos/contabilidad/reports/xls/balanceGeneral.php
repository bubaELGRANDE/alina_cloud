...
$nombre_archivo = "Balance de general al " . $dataPeriodo->periodo;
...
$cuenta_21111 = 0;
$cuenta_21113 = 0;
$cuenta_21114 = 0; // cuenta en suspenso 
$cuenta_22 = 0;
$cuenta_22105 = 0;
    ...
    <table id="tblReporte">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><b>OBLIGACIONES A CORTO PLAZO<br>(Sin Garantía Real)</b></td>
                <td></td>
            ...
            <tr>
                ...
                <td style="text-align: center;"><b>Lic. Hans Javier Hernandez Cruz</b></td>
                <td style="text-align: center;"></td>
                <td style="text-align: center;"></td>
            ...
            <tr>
                ...
                <td style="text-align: center;"></td>
                <td style="text-align: center;">Auditor Externo</td>
                <td style="text-align: center;"></td>
                <td style="text-align: center;"></td>
