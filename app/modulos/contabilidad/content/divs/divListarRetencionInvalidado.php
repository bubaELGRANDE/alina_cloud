<?php
  ...
  foreach($dataListaFacturas as $listaFactura) {
      ...
      if ($listaFactura->proveedorUbicacionId > 0) {
        ...
        $documentoCliente = '<b>NRC: </b>'. $listaFactura->nrcProveedor;
      } else {
        ...
        $documentoCliente = '<b>NRC: </b>'. $listaFactura->nrcCliente;
      }
...
?>
        <div class="compra-card compra-card-anulado mt-2">
            <div class="row mt-3">
                <div class="col-md-9">
                    <div class="row">
                    ...
                    <?php 
                        if($listaFactura->estadoFactura == "Anulado") {
                            $dataAnulacion = $cloud->row("
                                SELECT 
                                    fa.motivoAnulacion AS motivoAnulacion,
                                    fa.personaSolicita AS personaSolicita,
                                    DATE_FORMAT(fa.fechaAnulacion, '%d/%m/%Y') AS fechaAnulacionFormat,
                                    fa.horaAnulacion AS horaAnulacion
                                FROM fel_factura_anulacion$yearBD fa
                                WHERE fa.facturaId = ? AND fa.flgDelete = ?
                                ORDER BY fa.facturaAnulacionId DESC
                                LIMIT 1
                            ", [$listaFactura->facturaId, 0]);
                    ...
                    ?>
                            <div class="row border-top">
                                <div class="col-md-12 mb-2">
                                    <b><i class="fas fa-edit"></i> Motivo de anulación: </b><?php echo "$dataAnulacion->motivoAnulacion"; ?><br>
                                </div>
                            </div>
                            <div class='row'>
                                <div class="col-md-6 mb-4">
                                    <b><i class="fas fa-calendar-day"></i> Fecha y hora de anulación: </b> <?php echo $dataAnulacion->fechaAnulacionFormat . " " . $dataAnulacion->horaAnulacion; ?>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <b><i class="fas fa-user"></i> Persona solicita: </b><?php echo "$dataAnulacion->personaSolicita"; ?><br>
                                </div>
                            </div>
                    <?php 
                        } 
...
<?php
        ...
        // No se ha certificado o dio error
      }
