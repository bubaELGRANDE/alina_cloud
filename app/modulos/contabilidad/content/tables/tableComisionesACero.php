<?php
	...
	$dataComisionRevision = $cloud->rows("
		...
		WHERE comisionPagarPeriodoId = ? AND flgIdentificador = 'F' AND comisionPagar = '0.00' AND flgComisionEditar = '0' AND flgDelete = '0' AND nombreEmpleado NOT IN ('OFICINA CASA MATRIZ', 'OFICINA SUC. KARCHER CENTER', 'DISTRIBUCION KARCHER', 'TALLER HIDROPAL', 'OFICINA SUC. HIDROPAL', 'OFICINA SUC. SANTA ANA', 'OFICINA SUC. SAN MIGUEL', 'OFICINA SUC. NOGUEIRA', 'MAYOREO KARCHER', 'TALLER', 'OFICINA AGROPAL SAN MIGUEL', 'OFICINA INDUPAL 25', 'OFICINA LINEA INDUSTRIAL')
	...
	$dataComisionRevision = $cloud->rows("
		SELECT
			...
			comisionPagarEditar
		FROM conta_comision_pagar_calculo
		WHERE comisionPagarPeriodoId = ? AND flgIdentificador = 'A' AND comisionAbonoPagar = '0.00' AND flgComisionEditar = '0' AND flgDelete = '0' AND nombreEmpleado NOT IN ('OFICINA CASA MATRIZ', 'OFICINA SUC. KARCHER CENTER', 'DISTRIBUCION KARCHER', 'TALLER HIDROPAL', 'OFICINA SUC. HIDROPAL', 'OFICINA SUC. SANTA ANA', 'OFICINA SUC. SAN MIGUEL', 'OFICINA SUC. NOGUEIRA', 'MAYOREO KARCHER', 'TALLER', 'OFICINA AGROPAL SAN MIGUEL', 'OFICINA INDUPAL 25', 'OFICINA LINEA INDUSTRIAL')
