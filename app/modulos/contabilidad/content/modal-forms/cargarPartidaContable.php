...
$nombre_archivo = "Plantilla-Partida-ContableV2";

?>
<input type="hidden" id="partidaContableId" name="partidaContableId" value="<?php echo $_POST["partidaContableId"]; ?>">
<input type="hidden" id="partidaContaPeriodoId" name="partidaContaPeriodoId"
    value="<?php echo $_POST["partidaContaPeriodoId"]; ?>">
<div class="row">
...
<script>
    ...
    $(document).ready(function () {
        $("#btnDescargarExcel").click(function (e) {
            asyncXLS(
                "<?php echo $_SESSION['currentRoute']; ?>reports/xls/plantillaPartidaContableXLS",
                {
                ...
                function (data) {
                    mensaje_do_aceptar(
                        ...
                        `Plantilla de pedidos generada con éxito`,
                        `success`,
                        function () {
        ...
        $("#frmModal").validate({
            submitHandler: function (form) {
                ...
                asyncFile(
                    "<?php echo $_SESSION['currentRoute']; ?>reports/xls/cargarPartidaContableXLS",
                    form_data,
                    function (data) {
                        ...
                        if (data == "success") {
                            mensaje(
                                "Operación completada:",
                                'Detalles cargados a la partida con éxito.',
                                "success"
                            );
