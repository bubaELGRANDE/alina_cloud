...
$proveedor = $cloud->row("SELECT proveedorId,nombreProveedor
FROM comp_proveedores 
WHERE proveedorId = ? AND flgDelete = ?", [$_POST["proveedorId"], 0]);
...
<?php if ($_POST['typeOperation'] == "update") { ?>
    <input type="hidden" id="proveedorUbicacionId" name="proveedorUbicacionId"
        value="<?php echo $datProveedorUbicacion->proveedorUbicacionId; ?>">
<?php } ?>
<div class="row">
    <div class="col-lg-12">
        <div class="form-outline mb-4">
            <i class="fas fa-map-marker-alt trailing"></i>
            <input type="text" id="nombreProveedorUbicacion" class="form-control" name="nombreProveedorUbicacion"
                required />
